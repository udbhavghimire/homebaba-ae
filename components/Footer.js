...
const Footer = ({ cities }) => {
    return ( <
        ...
        p > < /p> <
        p >
        homebaba.ae provides up - to - date information on over 1, 000 pre construction homes across UAE, including detached,
        semi - detached, townhomes and condominiums.Prices, sizes,
        offerings and promotions are set by builders and subject to change without notice.homebaba.ae content is
        for reference only.We do not
        ...
        Link > <
        Link href = "https://www.instagram.com/dolphy_ca/"
        className = "me-2"
        target = "_blank" >
        <
        i className = "bi bi-instagram" > < /i> < /
        Link > <
        Link href = "https://www.tiktok.com/@homebaba.ae"
        className = "me-2"
        target = "_blank" >
        <
        ...
        p className = "mb-1" >
        8300 Woodbine Ave ste 500, Markham, ON L3R 9 Y7 <
        /p> <
        p className = "mb-1" > Office Hours⋅ 9 AM - 6 PM < /p> <
        p className = "mt-1 mb-1" >
        <
        strong > Phone: < /strong> <
        Link href = "tel:(587) 887-2572"
        className = "text-dark" >
        (587) 887 - 2572 <
        /Link> < /
        p > <
        ...
        <
        strong > Email: < /strong> <
        Link href = "mailto:hello@homebaba.ae"
        className = "text-dark" >
        hello @homebaba.ae <
        /Link> < /
        p > <
