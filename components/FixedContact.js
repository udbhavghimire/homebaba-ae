...
export default function FixedContact() {
    return ( <
        ...
        <
        div className = "alert alert-success bg-lightyellow2 alert-dismissible fade show mt-2 mb-0 rounded-3 d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row justify-content-start align-items-start gap-3 shadow-lg"
        role = "alert" >
        <
        div >
        <
