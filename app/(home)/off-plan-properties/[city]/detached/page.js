...
export async function generateMetadata({ params }, parent) {
    ...
    return {
        ...parent,
        alternates: {
            canonical: `https://homebaba.ae/off-plan-properties/${params.city}/detached/`,
        },
        ...
        description: `${city} upcoming Off Plan Detached Homes. Check out ${data.preconstructions.length}+ new construction detached homes on Dolphy. Floor plans & pricing updated for upcoming new construction detached homes in ${city}`,
    };
}
...
export default async function Home({ params }) {
    ...
    return ( <
        ...
        p className = "text-dark text-center text-md-start mb-2" > { `${
                data.preconstructions.length
              } Off Plan Detached Homes in ${CapitalizeFirst(
                params.city
              )} (Updated ${
                new Date().getMonth() +
                1 +
