...
export async function generateMetadata({ params }, parent) {
    ...
    return {
        ...parent,
        alternates: {
            canonical: `https://homebaba.ae/off-plan-properties/${params.city}/`,
        },
        title: data.preconstructions.length + " Preconstruction Homes in " + city,
        openGraph: {
            images: retImage(data.preconstructions),
        },
        description: `${city} Off Plan TownHomes, Detached & Condos. Check out ${data.preconstructions.length}+ new construction homes on Dolphy. Floor plans & pricing updated for new construction homes in ${city}`,
    };
}
...
export default async function Home({ params }) {
    ...
    return ( <
        ...
        /h1> <
        p className = "text-dark text-center text-md-start mb-2" > { `${data.preconstructions.length}+ New Off Plan Detached,
