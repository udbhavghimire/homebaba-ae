...
export async function generateMetadata({ params }, parent) {
    ...
    return {
        ...parent,
        alternates: {
            canonical: `https://homebaba.ae/off-plan-properties/${params.city}/upcoming/`,
        },
        title: data.preconstructions.length +
            " Upcoming Preconstruction Homes in " +
            city,
        openGraph: {
            images: retImage(data.preconstructions),
        },
        description: `${city} upcoming Off Plan TownHomes, Detached & Condos. Check out ${data.preconstructions.length}+ upcoming new construction homes on Dolphy. Floor plans & pricing updated for upcoming new construction homes in ${city}`,
    };
}
