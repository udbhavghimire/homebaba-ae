...
export default async function Home() {
    ...
    return ( <
            ...
            Calgary 's Top off plan properties Platform < /
            h4 > <
            p className = "text-center fs-small fs-md-5 mt-2 fw-less mt-md-0" >
            A platform
            for everyone, no matter where you come from <
            /p>
            ...
            Explore 20 + current & past new homes communities from Truman homes in Calgary <
            /p> <
            Link href = { "/off-plan-properties/calgary" }
            ...
            <
            Link href = { `#` }
            className = "mb-0 fs-small link-black" >
            Ambleton <
            /Link> <
            Link href = { `#` }
            className = "mb-0 fs-small link-black" >
    ...
    div className = "side-text" >
        <
        p >
        Dolphy has one of the largest, most updated database of new construction homes, backed by industry - leading technology and partners. <
        /p> <
