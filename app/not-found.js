...
export default async function NotFound() {
    ...
    return ( <
        ...
        <
        img src = "/dolphy-page-not-found.jpg"
        ...
        <
        Link href = { "/off-plan-properties/calgary/" }
        ...
        <
        /p> <
        Link href = { "/greater-toronto-area/" }
        ...
        <
        div className = "alert alert-success bg-lightyellow alert-dismissible fade show mt-2 mb-0 rounded-3 d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row justify-content-start align-items-start gap-3"
        role = "alert" >
        <
        div >
        <
        ...
        Looking
        for New Construction Homes in Calgary ?
        <
        /p> <
        ...
        /div> <
        /div> <
        Link className = "btn btn-white link-black"
        ...
        href = { "/off-plan-properties/toronto/" } >
        <
        ...
        <
        Link className = "link-black"
        href = { "/off-plan-properties/brampton/" } >
        <
        ...
        <
        Link className = "link-black"
        href = { "/off-plan-properties/mississauga/" } >
        <
