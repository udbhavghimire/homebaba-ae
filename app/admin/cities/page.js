...
export default function Cities() {
  ...
  const handleCreateCity = (e) => {
    ...
    axios
      .post("https://api.homebaba.ae/api/city/", citydata)
      .then((res) => {
        setRefetcch(!refetch);
        setCityData(stat);
        setModalCity(false);
  ...
  const handleUpdateCity = (e) => {
    ...
    axios
      .put(`https://api.homebaba.ae/api/city/${citydata.id}/`, updatecitydata)
      .then((res) => {
        setModalCity(false);
        setIsEdit(false);
        setRefetcch(!refetch);
  ...
  function deleteEvent(id) {
    axios
      .delete(`https://api.homebaba.ae/api/city/${id}/`)
      .then((res) => {
        console.log(res);
        setRefetcch(!refetch);
      })
  ...
  const handleEdit = (e, id) => {
    e.preventDefault();
    axios
      .get(`https://api.homebaba.ae/api/city/${id}/`)
      .then((res) => {
