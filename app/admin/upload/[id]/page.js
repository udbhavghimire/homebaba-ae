...
export default function Update({ params }) {
  ...
  const handleCreateDeveloper = (e) => {
    ...
    axios
      .post("https://api.homebaba.ae/api/developers/", developerdata, {
        headers: {
  ...
  useEffect(() => {
    axios
      .get("https://api.homebaba.ae/api/city/")
      .then((res) => {
    ...
    axios
      .get("https://api.homebaba.ae/api/developers/")
      .then((res) => {
        console.log(res.data.results);
    ...
    axios
      .get("https://api.homebaba.ae/api/preconstructions/" + params.id + "/")
      .then((res) => {
        setPredata(res.data);
      })
      .catch((err) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(
        `https://api.homebaba.ae/api/preconstructions/${predata.id}/`,
        alldata,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleDeleteUploadedImage = (image) => {
    swal({
      ...
      if (willDelete) {
        axios
          .delete(`https://api.homebaba.ae/api/delete-image/${image.id}/`)
          .then((res) => {
            console.log(res.data);
            setRefetch(!refetch);
  ...
  const handleDeleteUploadedPlan = (plan) => {
    swal({
      ...
      if (willDelete) {
        axios
          .delete(`https://api.homebaba.ae/api/delete-floorplan/${plan.id}/`)
          .then((res) => {
            console.log(res.data);
            setRefetch(!refetch);
