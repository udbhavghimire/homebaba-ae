...
export async function generateMetadata({ params }, parent) {
  ...
  return {
    ...parent,
    alternates: {
      canonical: `https://homebaba.ae/${params.city}/townhomes/`,
    },
    title:
    ...
    description: `${city} upcoming pre construction Townhomes. Check out ${data.preconstructions.length}+ new construction townhomes on Homebaba.ae. Floor plans & pricing updated for upcoming new construction townhomes in ${city}`,
  };
}
