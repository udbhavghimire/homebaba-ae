...
export async function generateMetadata({ params }, parent) {
  ...
  return {
    ...parent,
    alternates: {
      canonical: `https://homebaba.ae/pre-construction-homes/${params.city}/detached/`,
    },
    title:
    ...
    description: `${city} upcoming pre construction Detached Homes. Check out ${data.preconstructions.length}+ new construction detached homes on Homebaba.ae. Floor plans & pricing updated for upcoming new construction detached homes in ${city}`,
  };
}
